          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a id="empleado" class="dropdown-item" href="">Empleado</a></li>
                <hr class="dropdown-divider">
                <li><a id="producto" class="dropdown-item" href="registro_producto.php">Producto</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a id="ventas" class="nav-link" aria-current="page" href="">Ventas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="">Cerrar sesion</a>
            </li>
          </ul>
          <!-- <form class="d-flex">
